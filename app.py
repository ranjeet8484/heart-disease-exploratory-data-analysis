...
with tab_overview:
    ...
    with c4:
        ...
        st.markdown(
            ...
            This app is designed as an interactive EDA report: it helps recruiters quickly see how you explore
            demographics, clinical signals, and correlations before any predictive modeling.
            </div>
            """,
            unsafe_allow_html=True,
        )
